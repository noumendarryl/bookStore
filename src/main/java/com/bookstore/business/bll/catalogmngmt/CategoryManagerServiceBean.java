...
public class CategoryManagerServiceBean{
    ...
    public List<Category> getRootCategories() {
        TypedQuery<Category> query = em.createQuery(
                "SELECT c FROM Category c WHERE c.parentCategory = :parentCategory", Category.class);
        query.setParameter("parentCategory", null);
    ...
    */
    public List<Category> getChildrenCategories(Long parentId) {
        TypedQuery<Category> query = em.createQuery(
                "SELECT c FROM Category c WHERE c.parentCategory = :parentCat", Category.class);
        Category cat = em.find(Category.class, parentId);
        query.setParameter("parentCat", cat);
