...
public class Category implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "appartient", joinColumns = @JoinColumn(name = "ID_CATEGORIE"), foreignKey = @ForeignKey(name = "ID_CATEGORIE"),  inverseJoinColumns = @JoinColumn(name = "ID_LIVRE"), inverseForeignKey = @ForeignKey(name = "ID_LIVRE"))
